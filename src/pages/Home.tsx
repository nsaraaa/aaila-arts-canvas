...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="fade-in-up">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-bold mb-6 leading-tight">
                Hi, I'm{" "}
                <span className="text-primary">Aaila Zahra</span>
              </h1>
              <p className="text-xl sm:text-2xl font-heading text-muted-foreground mb-4">
                Visual artist & craft creator
              </p>
              <p className="text-lg font-body text-foreground/80 mb-8 max-w-xl">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link to="/portfolio">
              <Button size="lg" variant="outline" className="group font-body">
                View All Artworks
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={20} />
              </Button>
            </Link>
      ...
      {/* CTA Section */}
      <section className="py-20 artistic-gradient">
